			    ...
			    <div class="tab-pane active" id="tab-general">
				  ...
				  <div class="form-group">
					...
					<div class="col-sm-10">
					  ...
					  <?php if ($error_FreeShippingAmount) { ?>
				...
				<div class="tab-pane" id="tab-unimart-collection">
				  <div class="form-group">
					...
					<div class="col-sm-10">
					  ...
					  <?php if ($error_UNIMART_Collection_fee) { ?>
				...
				<div class="tab-pane" id="tab-fami-collection">
				  <div class="form-group">
					...
					<div class="col-sm-10">
					  ...
					  <?php if ($error_FAMI_Collection_fee) { ?>
